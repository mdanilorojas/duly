...
export const themes: Record<string, Record<string, string>> = {
  cockpit: {
    ...
    "ok": "#18A850|oklch(0.64 0.17 150)", "on-ok": "#04231a|oklch(0.24 0.04 162)",
    "review": "#6cb8ff|oklch(0.76 0.13 256)", "on-review": "#04122b|oklch(0.20 0.05 256)",
    "warn": "#FFC000|oklch(0.84 0.17 85)", "on-warn": "#2a1600|oklch(0.22 0.05 70)",
    "block": "#FF1A1A|oklch(0.63 0.25 28)", "on-block": "#2b0407|oklch(0.22 0.06 19)",
