...
export const themes: Record<string, Record<string, string>> = {
  cockpit: {
    ...
    "surface-header": "#131318|oklch(0.21 0.009 285)",
    "surface-sunken": "#0f1014|oklch(0.185 0.008 285)",
    "ink": NEUTRAL.ink, "dim": NEUTRAL.dim, "faint": NEUTRAL.faint, "faint-deco": NEUTRAL.faintDeco,
    // Bordes claramente visibles sobre las superficies oscuras: en 0.26/0.32 se perdían.
    "border-subtle": "#26272e|oklch(0.32 0.012 285)",
    "border-default": "#37383f|oklch(0.41 0.011 285)",
    "border-strong": "#6a6b76|oklch(0.65 0.010 285)",
    "border-divider": "#2c3744|oklch(0.37 0.02 241)",
