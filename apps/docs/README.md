...
Interactive component documentation for Duly, powered by Storybook 8.
...
1. `@import "@duly/tokens/css"` pulls in the full Tailwind engine plus all theme variable layers. This is the only place in the monorepo where the full bundle is imported directly.
