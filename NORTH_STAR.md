...
| AgentMetric / AgentStatusMatrix | Tiles de métrica y matriz de estatus con tonos semánticos | ✅ (V002, Storybook `Agentic/Property Intelligence` — modo `density="compact"` heatmap, flag `critical`, handler `onSelectItem`) |
